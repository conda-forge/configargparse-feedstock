About configargparse-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/configargparse-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/configargparse-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add configargparse
# for installing globally
pixi global install configargparse
```
...
It is possible to list all of the versions of `configargparse` available on your platform:
...
```
mamba search configargparse --channel conda-forge
```
...
```
pixi search configargparse --channel conda-forge
```
...
mamba repoquery search configargparse --channel conda-forge

# List packages depending on `configargparse`:
mamba repoquery whoneeds configargparse --channel conda-forge

# List dependencies of `configargparse`:
mamba repoquery depends configargparse --channel conda-forge
```
